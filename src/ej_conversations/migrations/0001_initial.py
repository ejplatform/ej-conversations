# Generated by Django 2.0 on 2018-04-12 02:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(default=None, editable=False, null=True, populate_from='name', slugify=ej_conversations.utils.custom_slugify, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('background_image', models.ImageField(blank=True, null=True, upload_to='conversations/backgrounds', verbose_name='Background image')),
                ...
                ('conversation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='style', to='ej_conversations.Conversation')),
            ],
        ),
        migrations.CreateModel(
            name='Limits',
