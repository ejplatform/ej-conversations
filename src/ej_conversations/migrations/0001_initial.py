# Generated by Django 2.0 on 2018-04-22 18:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(help_text='A memorable description of your limit configuration. The description is used to reference this configuration in other conversation objects.', max_length=140, unique=True, verbose_name='Description')),
